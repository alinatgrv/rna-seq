...
```bash
ls -lah results/tables
head -n 5 results/tables/result.txt
head -n 3 results/tables/norm-matrix-deseq2.txt
```
...
**Interpretation rule:**
- positive `log2FoldChange` → upregulated in fermentation
